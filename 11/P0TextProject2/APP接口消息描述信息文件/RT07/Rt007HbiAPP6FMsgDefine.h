...
#define LEN_HTX/RT7-APP1-BE/08     0x11170     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
/* RX MSG LIST:*/                                            
#define RT6F_RX_NUM                0x0019     /*APP_ID，RT APP发送应用消息包个数，不大于256*/
...
#define HRX/RT4-APP1-BE/0A         0x000A     /*MSG_NAME=HRX/RT4-APP1-BE/0A（接收消息物理块名），0x000A：终端接收消息序号*/
#define LEN_HRX/RT4-APP1-BE/0A     0xC350     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
...
#define HRX/RT8-APP1-BE/10         0x0010     /*MSG_NAME=HRX/RT8-APP1-BE/10（接收消息物理块名），0x0010：终端接收消息序号*/
#define LEN_HRX/RT8-APP1-BE/10     0x13880     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT9-APP1-ST/11         0x0011     /*MSG_NAME=HRX/RT9-APP1-ST/11（接收消息物理块名），0x0011：终端接收消息序号*/
#define LEN_HRX/RT9-APP1-ST/11     0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT9-APP1-ST/12         0x0012     /*MSG_NAME=HRX/RT9-APP1-ST/12（接收消息物理块名），0x0012：终端接收消息序号*/
#define LEN_HRX/RT9-APP1-ST/12     0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT11-APP1-RC/13        0x0013     /*MSG_NAME=HRX/RT11-APP1-RC/13（接收消息物理块名），0x0013：终端接收消息序号*/
#define LEN_HRX/RT11-APP1-RC/13    0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
...
#define HRX/RT12-APP1-ST/15        0x0015     /*MSG_NAME=HRX/RT12-APP1-ST/15（接收消息物理块名），0x0015：终端接收消息序号*/
#define LEN_HRX/RT12-APP1-ST/15    0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT12-APP1-ST/16        0x0016     /*MSG_NAME=HRX/RT12-APP1-ST/16（接收消息物理块名），0x0016：终端接收消息序号*/
#define LEN_HRX/RT12-APP1-ST/16    0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT12-APP1-RC/17        0x0017     /*MSG_NAME=HRX/RT12-APP1-RC/17（接收消息物理块名），0x0017：终端接收消息序号*/
#define LEN_HRX/RT12-APP1-RC/17    0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT12-APP1-RC/18        0x0018     /*MSG_NAME=HRX/RT12-APP1-RC/18（接收消息物理块名），0x0018：终端接收消息序号*/
#define LEN_HRX/RT12-APP1-RC/18    0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
