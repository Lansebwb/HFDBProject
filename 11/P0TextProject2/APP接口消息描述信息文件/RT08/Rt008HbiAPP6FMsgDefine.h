...
#define LEN_HTX/RT8-APP1-BE/08     0x13880     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
/* RX MSG LIST:*/                                            
#define RT6F_RX_NUM                0x0018     /*APP_ID，RT APP发送应用消息包个数，不大于256*/
...
#define HRX/RT6-APP1-BE/0A         0x000A     /*MSG_NAME=HRX/RT6-APP1-BE/0A（接收消息物理块名），0x000A：终端接收消息序号*/
#define LEN_HRX/RT6-APP1-BE/0A     0x13880     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
...
#define HRX/RT11-APP1-RC/0D        0x000D     /*MSG_NAME=HRX/RT11-APP1-RC/0D（接收消息物理块名），0x000D：终端接收消息序号*/
#define LEN_HRX/RT11-APP1-RC/0D    0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT11-APP1-BE/0E        0x000E     /*MSG_NAME=HRX/RT11-APP1-BE/0E（接收消息物理块名），0x000E：终端接收消息序号*/
#define LEN_HRX/RT11-APP1-BE/0E    0x9C40     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT12-APP1-ST/0F        0x000F     /*MSG_NAME=HRX/RT12-APP1-ST/0F（接收消息物理块名），0x000F：终端接收消息序号*/
#define LEN_HRX/RT12-APP1-ST/0F    0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
...
#define HRX/RT16-APP1-RC/11        0x0011     /*MSG_NAME=HRX/RT16-APP1-RC/11（接收消息物理块名），0x0011：终端接收消息序号*/
#define LEN_HRX/RT16-APP1-RC/11    0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT15-APP1-RC/12        0x0012     /*MSG_NAME=HRX/RT15-APP1-RC/12（接收消息物理块名），0x0012：终端接收消息序号*/
#define LEN_HRX/RT15-APP1-RC/12    0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT15-APP1-RC/13        0x0013     /*MSG_NAME=HRX/RT15-APP1-RC/13（接收消息物理块名），0x0013：终端接收消息序号*/
#define LEN_HRX/RT15-APP1-RC/13    0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT15-APP1-BE/14        0x0014     /*MSG_NAME=HRX/RT15-APP1-BE/14（接收消息物理块名），0x0014：终端接收消息序号*/
#define LEN_HRX/RT15-APP1-BE/14    0xFDE8     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT16-APP1-ST/15        0x0015     /*MSG_NAME=HRX/RT16-APP1-ST/15（接收消息物理块名），0x0015：终端接收消息序号*/
#define LEN_HRX/RT16-APP1-ST/15    0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT1-APP1-ST/16         0x0016     /*MSG_NAME=HRX/RT1-APP1-ST/16（接收消息物理块名），0x0016：终端接收消息序号*/
#define LEN_HRX/RT1-APP1-ST/16     0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT1-APP1-RC/17         0x0017     /*MSG_NAME=HRX/RT1-APP1-RC/17（接收消息物理块名），0x0017：终端接收消息序号*/
#define LEN_HRX/RT1-APP1-RC/17     0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
