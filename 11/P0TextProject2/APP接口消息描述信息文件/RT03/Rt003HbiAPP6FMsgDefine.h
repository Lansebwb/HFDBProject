...
#define LEN_HTX/RT3-APP1-BE/08     0xC350     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
/* RX MSG LIST:*/                                            
...
#define HRX/RT1-APP1-RC/06         0x0006     /*MSG_NAME=HRX/RT1-APP1-RC/06（接收消息物理块名），0x0006：终端接收消息序号*/
#define LEN_HRX/RT1-APP1-RC/06     0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT1-APP1-BE/07         0x0007     /*MSG_NAME=HRX/RT1-APP1-BE/07（接收消息物理块名），0x0007：终端接收消息序号*/
#define LEN_HRX/RT1-APP1-BE/07     0x493E0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
...
#define HRX/RT2-APP1-ST/09         0x0009     /*MSG_NAME=HRX/RT2-APP1-ST/09（接收消息物理块名），0x0009：终端接收消息序号*/
#define LEN_HRX/RT2-APP1-ST/09     0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
...
#define HRX/RT4-APP1-RC/0B         0x000B     /*MSG_NAME=HRX/RT4-APP1-RC/0B（接收消息物理块名），0x000B：终端接收消息序号*/
#define LEN_HRX/RT4-APP1-RC/0B     0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT4-APP1-BE/0C         0x000C     /*MSG_NAME=HRX/RT4-APP1-BE/0C（接收消息物理块名），0x000C：终端接收消息序号*/
#define LEN_HRX/RT4-APP1-BE/0C     0xC350     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT5-APP1-ST/0D         0x000D     /*MSG_NAME=HRX/RT5-APP1-ST/0D（接收消息物理块名），0x000D：终端接收消息序号*/
#define LEN_HRX/RT5-APP1-ST/0D     0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT5-APP1-ST/0E         0x000E     /*MSG_NAME=HRX/RT5-APP1-ST/0E（接收消息物理块名），0x000E：终端接收消息序号*/
#define LEN_HRX/RT5-APP1-ST/0E     0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT6-APP1-RC/0F         0x000F     /*MSG_NAME=HRX/RT6-APP1-RC/0F（接收消息物理块名），0x000F：终端接收消息序号*/
#define LEN_HRX/RT6-APP1-RC/0F     0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT6-APP1-RC/10         0x0010     /*MSG_NAME=HRX/RT6-APP1-RC/10（接收消息物理块名），0x0010：终端接收消息序号*/
#define LEN_HRX/RT6-APP1-RC/10     0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT6-APP1-BE/11         0x0011     /*MSG_NAME=HRX/RT6-APP1-BE/11（接收消息物理块名），0x0011：终端接收消息序号*/
#define LEN_HRX/RT6-APP1-BE/11     0x13880     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT7-APP1-ST/12         0x0012     /*MSG_NAME=HRX/RT7-APP1-ST/12（接收消息物理块名），0x0012：终端接收消息序号*/
#define LEN_HRX/RT7-APP1-ST/12     0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT7-APP1-ST/13         0x0013     /*MSG_NAME=HRX/RT7-APP1-ST/13（接收消息物理块名），0x0013：终端接收消息序号*/
#define LEN_HRX/RT7-APP1-ST/13     0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT6-APP1-ST/14         0x0014     /*MSG_NAME=HRX/RT6-APP1-ST/14（接收消息物理块名），0x0014：终端接收消息序号*/
#define LEN_HRX/RT6-APP1-ST/14     0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT6-APP1-RC/15         0x0015     /*MSG_NAME=HRX/RT6-APP1-RC/15（接收消息物理块名），0x0015：终端接收消息序号*/
#define LEN_HRX/RT6-APP1-RC/15     0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT6-APP1-RC/16         0x0016     /*MSG_NAME=HRX/RT6-APP1-RC/16（接收消息物理块名），0x0016：终端接收消息序号*/
#define LEN_HRX/RT6-APP1-RC/16     0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
