...
#define HRX/RT8-APP1-BE/15         0x0015     /*MSG_NAME=HRX/RT8-APP1-BE/15（接收消息物理块名），0x0015：终端接收消息序号*/
#define LEN_HRX/RT8-APP1-BE/15     0x13880     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
...
#define HRX/RT9-APP1-ST/17         0x0017     /*MSG_NAME=HRX/RT9-APP1-ST/17（接收消息物理块名），0x0017：终端接收消息序号*/
...
#define HRX/RT9-APP1-RC/19         0x0019     /*MSG_NAME=HRX/RT9-APP1-RC/19（接收消息物理块名），0x0019：终端接收消息序号*/
#define LEN_HRX/RT9-APP1-RC/19     0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
...
#define HRX/RT10-APP1-ST/1C        0x001C     /*MSG_NAME=HRX/RT10-APP1-ST/1C（接收消息物理块名），0x001C：终端接收消息序号*/
#define LEN_HRX/RT10-APP1-ST/1C    0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
...
#define HRX/RT10-APP1-RC/1F        0x001F     /*MSG_NAME=HRX/RT10-APP1-RC/1F（接收消息物理块名），0x001F：终端接收消息序号*/
#define LEN_HRX/RT10-APP1-RC/1F    0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
