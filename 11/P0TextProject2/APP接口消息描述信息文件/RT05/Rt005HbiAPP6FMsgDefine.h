...
#define LEN_HTX/RT5-APP1-BE/08     0xEA60     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
/* RX MSG LIST:*/                                            
...
#define HRX/RT3-APP1-BE/09         0x0009     /*MSG_NAME=HRX/RT3-APP1-BE/09（接收消息物理块名），0x0009：终端接收消息序号*/
#define LEN_HRX/RT3-APP1-BE/09     0xC350     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
...
#define HRX/RT4-APP1-ST/0B         0x000B     /*MSG_NAME=HRX/RT4-APP1-ST/0B（接收消息物理块名），0x000B：终端接收消息序号*/
#define LEN_HRX/RT4-APP1-ST/0B     0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
...
#define HRX/RT6-APP1-BE/0E         0x000E     /*MSG_NAME=HRX/RT6-APP1-BE/0E（接收消息物理块名），0x000E：终端接收消息序号*/
#define LEN_HRX/RT6-APP1-BE/0E     0x13880     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
...
#define HRX/RT10-APP1-RC/11        0x0011     /*MSG_NAME=HRX/RT10-APP1-RC/11（接收消息物理块名），0x0011：终端接收消息序号*/
#define LEN_HRX/RT10-APP1-RC/11    0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT10-APP1-BE/12        0x0012     /*MSG_NAME=HRX/RT10-APP1-BE/12（接收消息物理块名），0x0012：终端接收消息序号*/
#define LEN_HRX/RT10-APP1-BE/12    0xC350     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
