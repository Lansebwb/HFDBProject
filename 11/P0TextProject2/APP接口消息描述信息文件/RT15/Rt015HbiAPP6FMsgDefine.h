...
#define LEN_HTX/RT15-APP1-BE/08    0xFDE8     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
/* RX MSG LIST:*/                                            
...
#define HRX/RT7-APP1-RC/0B         0x000B     /*MSG_NAME=HRX/RT7-APP1-RC/0B（接收消息物理块名），0x000B：终端接收消息序号*/
#define LEN_HRX/RT7-APP1-RC/0B     0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT7-APP1-BE/0C         0x000C     /*MSG_NAME=HRX/RT7-APP1-BE/0C（接收消息物理块名），0x000C：终端接收消息序号*/
#define LEN_HRX/RT7-APP1-BE/0C     0x11170     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
...
#define HRX/RT9-APP1-BE/10         0x0010     /*MSG_NAME=HRX/RT9-APP1-BE/10（接收消息物理块名），0x0010：终端接收消息序号*/
#define LEN_HRX/RT9-APP1-BE/10     0xEA60     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
