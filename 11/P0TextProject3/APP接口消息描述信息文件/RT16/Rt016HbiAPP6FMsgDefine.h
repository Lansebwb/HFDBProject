...
#define LEN_HTX/RT16-APP1-BE/08    0xAAE60     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
/* RX MSG LIST:*/                                            
#define RT6F_RX_NUM                0x0012     /*APP_ID，RT APP发送应用消息包个数，不大于256*/
...
#define HRX/RT5-APP1-ST/05         0x0005     /*MSG_NAME=HRX/RT5-APP1-ST/05（接收消息物理块名），0x0005：终端接收消息序号*/
#define LEN_HRX/RT5-APP1-ST/05     0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
...
#define HRX/RT12-APP1-RC/07        0x0007     /*MSG_NAME=HRX/RT12-APP1-RC/07（接收消息物理块名），0x0007：终端接收消息序号*/
#define LEN_HRX/RT12-APP1-RC/07    0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
...
#define HRX/RT13-APP1-ST/09        0x0009     /*MSG_NAME=HRX/RT13-APP1-ST/09（接收消息物理块名），0x0009：终端接收消息序号*/
#define LEN_HRX/RT13-APP1-ST/09    0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT13-APP1-ST/0A        0x000A     /*MSG_NAME=HRX/RT13-APP1-ST/0A（接收消息物理块名），0x000A：终端接收消息序号*/
#define LEN_HRX/RT13-APP1-ST/0A    0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
...
#define HRX/RT14-APP1-RC/0C        0x000C     /*MSG_NAME=HRX/RT14-APP1-RC/0C（接收消息物理块名），0x000C：终端接收消息序号*/
#define LEN_HRX/RT14-APP1-RC/0C    0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT15-APP1-ST/0D        0x000D     /*MSG_NAME=HRX/RT15-APP1-ST/0D（接收消息物理块名），0x000D：终端接收消息序号*/
#define LEN_HRX/RT15-APP1-ST/0D    0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT15-APP1-ST/0E        0x000E     /*MSG_NAME=HRX/RT15-APP1-ST/0E（接收消息物理块名），0x000E：终端接收消息序号*/
#define LEN_HRX/RT15-APP1-ST/0E    0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT2-APP1-ST/0F         0x000F     /*MSG_NAME=HRX/RT2-APP1-ST/0F（接收消息物理块名），0x000F：终端接收消息序号*/
#define LEN_HRX/RT2-APP1-ST/0F     0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT4-APP1-RC/10         0x0010     /*MSG_NAME=HRX/RT4-APP1-RC/10（接收消息物理块名），0x0010：终端接收消息序号*/
#define LEN_HRX/RT4-APP1-RC/10     0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT4-APP1-RC/11         0x0011     /*MSG_NAME=HRX/RT4-APP1-RC/11（接收消息物理块名），0x0011：终端接收消息序号*/
#define LEN_HRX/RT4-APP1-RC/11     0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
