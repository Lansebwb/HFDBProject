...
#define LEN_HTX/RT12-APP1-BE/08    0x7A120     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
/* RX MSG LIST:*/                                            
#define RT6F_RX_NUM                0x0013     /*APP_ID，RT APP发送应用消息包个数，不大于256*/
...
#define HRX/RT3-APP1-RC/03         0x0003     /*MSG_NAME=HRX/RT3-APP1-RC/03（接收消息物理块名），0x0003：终端接收消息序号*/
#define LEN_HRX/RT3-APP1-RC/03     0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT4-APP1-ST/04         0x0004     /*MSG_NAME=HRX/RT4-APP1-ST/04（接收消息物理块名），0x0004：终端接收消息序号*/
#define LEN_HRX/RT4-APP1-ST/04     0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT4-APP1-ST/05         0x0005     /*MSG_NAME=HRX/RT4-APP1-ST/05（接收消息物理块名），0x0005：终端接收消息序号*/
#define LEN_HRX/RT4-APP1-ST/05     0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
...
#define HRX/RT6-APP1-ST/08         0x0008     /*MSG_NAME=HRX/RT6-APP1-ST/08（接收消息物理块名），0x0008：终端接收消息序号*/
#define LEN_HRX/RT6-APP1-ST/08     0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT8-APP1-RC/09         0x0009     /*MSG_NAME=HRX/RT8-APP1-RC/09（接收消息物理块名），0x0009：终端接收消息序号*/
#define LEN_HRX/RT8-APP1-RC/09     0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT8-APP1-RC/0A         0x000A     /*MSG_NAME=HRX/RT8-APP1-RC/0A（接收消息物理块名），0x000A：终端接收消息序号*/
#define LEN_HRX/RT8-APP1-RC/0A     0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
...
#define HRX/RT10-APP1-RC/0C        0x000C     /*MSG_NAME=HRX/RT10-APP1-RC/0C（接收消息物理块名），0x000C：终端接收消息序号*/
#define LEN_HRX/RT10-APP1-RC/0C    0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
...
#define HRX/RT14-APP1-RC/0F        0x000F     /*MSG_NAME=HRX/RT14-APP1-RC/0F（接收消息物理块名），0x000F：终端接收消息序号*/
#define LEN_HRX/RT14-APP1-RC/0F    0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
