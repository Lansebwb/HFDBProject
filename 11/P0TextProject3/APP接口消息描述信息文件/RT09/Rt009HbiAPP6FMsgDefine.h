...
#define LEN_HTX/RT9-APP1-BE/08     0x927C0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
/* RX MSG LIST:*/                                            
...
#define HRX/RT16-APP1-ST/08        0x0008     /*MSG_NAME=HRX/RT16-APP1-ST/08（接收消息物理块名），0x0008：终端接收消息序号*/
#define LEN_HRX/RT16-APP1-ST/08    0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
