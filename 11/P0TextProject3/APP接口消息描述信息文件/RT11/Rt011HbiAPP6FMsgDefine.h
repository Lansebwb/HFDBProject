...
#define LEN_HTX/RT11-APP1-BE/08    0x61A80     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
/* RX MSG LIST:*/                                            
#define RT6F_RX_NUM                0x000C     /*APP_ID，RT APP发送应用消息包个数，不大于256*/
...
#define HRX/RT10-APP1-ST/08        0x0008     /*MSG_NAME=HRX/RT10-APP1-ST/08（接收消息物理块名），0x0008：终端接收消息序号*/
#define LEN_HRX/RT10-APP1-ST/08    0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
#define HRX/RT13-APP1-RC/09        0x0009     /*MSG_NAME=HRX/RT13-APP1-RC/09（接收消息物理块名），0x0009：终端接收消息序号*/
#define LEN_HRX/RT13-APP1-RC/09    0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
...
#define HRX/RT14-APP1-ST/0B        0x000B     /*MSG_NAME=HRX/RT14-APP1-ST/0B（接收消息物理块名），0x000B：终端接收消息序号*/
#define LEN_HRX/RT14-APP1-ST/0B    0x07D0     /*MSG_LEN:unit 32bits WORD,≤0x0200*/
